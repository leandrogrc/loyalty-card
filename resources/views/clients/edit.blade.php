...
<div class="min-h-screen bg-gray-50 p-4 sm:p-6">
    <div class="max-w-md mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Atualizar Cliente</h1>
        </div>
        <!-- Card com sombra mais suave em mobile -->
        <div class="bg-white shadow-sm sm:shadow rounded-lg overflow-hidden">
            <div class="p-4 sm:p-6">
                <form action="{{ route('clients.update', ['client' => $client->id] ) }}" method="POST" class="space-y-4 sm:space-y-6">
                    @csrf
                    @method('PUT')
                    <!-- Campo Nome -->
                    <div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="phone" id="phone" placeholder="{{ $client->phone }}"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base"
