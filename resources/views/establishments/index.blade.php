...
@section('content')
@if(session('success'))
<div class="mb-4 mx-4 sm:mx-0 p-4 bg-green-100 border-l-4 border-green-500 text-green-700 rounded flex justify-between items-center">
...
<div class="min-h-screen bg-gray-50 p-4 sm:p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4">
            ...
            <a href="{{ route('establishments.create') }}" class="w-full sm:w-auto inline-flex justify-center items-center px-3 py-2 sm:px-4 sm:py-2 border border-transparent rounded-md shadow-sm text-xs sm:text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
        ...
        <div class="bg-white rounded-lg shadow p-4 sm:p-8 text-center">
            ...
            <p class="mt-1 text-xs sm:text-sm text-gray-500">Comece cadastrando seu primeiro estabelecimento.</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <a href="{{ route('establishments.show', $establishment->id) }}" class="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition transform hover:-translate-y-0.5 sm:hover:-translate-y-1">
                <div class="p-4 sm:p-6">
                    <div class="flex justify-between items-start">
                        <h3 class="text-base sm:text-lg font-semibold text-gray-800 truncate">{{ $establishment->establishment_name }}</h3>
                        <span class="px-2 py-0.5 sm:py-1 bg-green-100 text-green-800 text-xxs sm:text-xs rounded-full">Ativo</span>
                    </div>

                    <div class="mt-3 sm:mt-4 space-y-1 sm:space-y-2 text-xs sm:text-sm text-gray-600">
                ...
                <div class="px-4 py-2 sm:px-6 sm:py-3 bg-gray-50 text-right text-xxs sm:text-xs text-gray-500">
